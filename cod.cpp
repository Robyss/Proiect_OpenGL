...
double ok = 1;
double j = 0.0; // oy politist
double i = 0.0; // ox negri
double contor = 0;
double loc_vert = 800;
int vector_c[3] = {0, 160, 320};
double height = vector_c[rand() % 3];
int score = 0;
double timp = 10.15;
int pct = 1000;
...
void init(void)
{
    glClearColor(0.561, 0.58, 0.569, 0.0);
